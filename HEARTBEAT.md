...
3. Read `task-todo/current-requirement.md`, `task-todo/current-split-task.md`, and `C:\Users\25472\Desktop\kioku\today.md`.
...
12. If the primary QQ send attempt fails, retry once. If it still fails, send a shorter fallback report with the same script and record the failure in `C:\Users\25472\Desktop\kioku\today.md`.
...
14. After each substantial change, append a short update to `C:\Users\25472\Desktop\kioku\today.md`.
